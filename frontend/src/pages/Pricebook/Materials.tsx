// frontend/src/pages/Pricebook/Materials.tsx
...
export default function Materials() {
  const type = "material" as const;

  const breadCrumb = useMemo(() => [{ label: "Pricebook" }, { label: "Materials" }], []);
  ...
  return (
    <div>
      <PageBreadCrumb title="Materials" breadCrumb={breadCrumb} />
          ...
          <table className="w-full table-auto">
            <thead>
              <tr className="border-b border-gray-200 text-left dark:border-gray-800">
                ...
                <th className="px-4 py-3 text-xs font-semibold uppercase text-gray-500">Unit</th>
              ...
              {loading ? (
                ...
                items.map((it) => (
                  <tr key={it._id} className="border-b border-gray-100 dark:border-gray-800">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{it.unit || "—"}</td>
